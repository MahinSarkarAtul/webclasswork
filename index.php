  ...
  <style>
    * {
    ...
    .container {
      ...
      flex-direction: column;
      max-width: 1200px;
      background-color: rgb(97, 76, 136);
      padding: 20px;
    }
   ...
   .box2, .box4 {
    ...
    .box3 form {
      flex: 1;
      overflow-y: auto; /*vertically add scrollbar if exit the height of box3*/
      display: flex;
    ...
    button:hover {
      /* pseudo-class: hover; whole element*/
      background-color: #4553a0;
    }
 
    .box3 form::-webkit-scrollbar {
      /* pseudo-element: scrollbar; speicfic part*/
      width: 8px;
    }
    ...
    .overlay {
      ...
      top: 11px;
      left: -8px;
      width: 95%; /* Covers one-third of the table */
      height: 100%; /* Full height of the table */
      background-color: #131212; /* Semi-transparent background */
      z-index: 2; /* Ensure it's on top of the table */
      display: flex;
      justify-content: center;
      align-items: center;
      font-size: 18px;
...
<body>
  <div class="container">
    ...
    <div class="title">Welcome to Today's Air Index Viewport</div>
    <div class="grid">
      <div class="left-column">
        ...
        <div class="box1">
          ...
          <div class="table-container">
            <!-- Overlay Div placed over the table -->
            <div class="overlay">
              <div class="box-content">Please Log In to View Full Data</div>
            </div>
            <table>
              <caption>Air index of top 10 Cities</caption>
              <tr>
                <th>City</th>
                <th>Country</th>
                <th>Air Index</th>
